    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pb-24 md:pb-32 px-6">
        <div className="container mx-auto max-w-6xl grid lg:grid-cols-5 gap-10 md:gap-14">
          ...
          >
            <h2 className="font-heading text-2xl md:text-3xl font-medium text-foreground tracking-tight mb-8">
              Reach Out
            </h2>
          ...
          >
            <div className="rounded-2xl border border-border bg-card p-7 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button type="submit" variant="gold" size="lg" className="text-sm tracking-wider uppercase font-medium w-full sm:w-auto px-10 py-6">

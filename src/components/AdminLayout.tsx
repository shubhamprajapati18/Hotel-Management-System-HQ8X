...
export function AdminLayout({ children }: { children: ReactNode }) {
  ...
  // Ensure guest pages never get dark class on <html>
  useEffect(() => {
  ...
  return (
    <div className={cn("min-h-screen flex", dark ? "dark" : "")} style={dark ? { colorScheme: "dark" } : undefined}>
      {/* Dark wrapper that provides CSS variable scope */}
      <div className="contents" style={dark ? {} : {}}>
        {/* Sidebar */}
        <aside
          className={cn(
